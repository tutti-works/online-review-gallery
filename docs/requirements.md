...
利用者は、Firebase Storage上の画像をレスポンシブCSS Gridのギャラリーで閲覧し、管理者は各作品に対して「いいね」やコメント形式でのフィードバックを行える。
...
**概要**: 作品をレスポンシブCSS Gridで表示し、モーダルで拡大表示、ソート・フィルタリング機能を提供

**主な機能**:
- F-03-01: レスポンシブCSS Grid表示
- F-03-02: 作品の拡大・複数ページ表示
- F-03-02a: モーダル内作品間ナビゲーション ✅
- F-03-03: ズーム・パン機能
- F-03-04: 並び替え・フィルタリング
- F-03-05: ギャラリー切り替え機能

**詳細**: [ギャラリー・フィードバック機能仕様](features/gallery-and-feedback.md)

### 3.4. 評価・フィードバック機能 (F-04)

**概要**: いいね、コメント、ラベル機能で作品にフィードバック

**主な機能**:
- F-04-01: いいね機能
- F-04-02: コメント機能
- F-04-03: 講評用評価ラベル（赤・青・緑 各1〜5、色ごとに0〜1個。詳細は[ギャラリー・フィードバック仕様](features/gallery-and-feedback.md#33-ラベル機能-f-04-03)）
- F-04-04: 作品削除機能
...
- F-05-01: 全データリセット
- F-05-02: ギャラリー別データ削除
- F-05-03: ギャラリー作品数同期機能 ✅

**詳細**: [ギャラリー・フィードバック機能仕様](features/gallery-and-feedback.md)

### 3.6. 作品注釈機能 (F-06) ✅ 完全実装（2025-11-05）

**概要**: 作品画像上に直接アノテーションを描画

**主な機能**:
- F-06-01: フリーハンド描画（Konva.js） ✅
- F-06-02: 注釈の編集（選択、移動、削除、消しゴム、元に戻す） ✅
- F-06-03: 注釈データの保存（Firestore、ベクトルデータ） ✅
- F-06-04: 注釈の表示/非表示切り替え ✅
- F-06-05: タブレット・タッチ対応 ✅

**詳細**: [アノテーション機能仕様](features/ANNOTATION_FEATURE.md)
...
- **フロントエンド:** Next.js 14 (React, TypeScript)
  ...
  - Tailwind CSS Gridによるレスポンシブレイアウト
- **バックエンド:**
...
- **2025-10-05:** GitHub Actionsプレビュー用デプロイ設定、Google Analytics有効化
...
### 機能仕様
- [インポート機能](features/import-feature.md) - F-02-07, F-02-08, F-02-09の詳細仕様
- [ギャラリー・フィードバック機能](features/gallery-and-feedback.md) - F-03, F-04, F-05の詳細仕様
- [アノテーション機能](features/ANNOTATION_FEATURE.md) - F-06の詳細仕様と実装状況
- [背景インポート機能](features/BACKGROUND_IMPORT.md) - インポート処理フロー

### 実装詳細
- [インポート実装](implementation/import-implementation.md) - フロントエンド・バックエンド実装
